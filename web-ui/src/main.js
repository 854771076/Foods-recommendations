...
app.config.globalProperties.$api = {
    ...
    foods:'/api/data/foods/',
    similarfoods:'/api/data/similar/',
    like:'/api/data/foods/like/',
    collect:'/api/data/foods/collect/',
    iscollected:'/api/data/foods/iscollected/',
    removecollect:'/api/data/foods/removecollect/',
    isliked:'/api/data/foods/isliked/',
    removelike:'/api/data/foods/removelike/',
    recommend:'/api/data/foods/recommend/',
    collectfoods:'/api/data/foods/collectFoods/',
    likefoods:'/api/data/foods/likeFoods/',
    guihua:'/api/data/foods/guihua/',
    comment:'/api/data/foods/comment/',
    commentfoods:'/api/data/foods/commentFoods/',
}
