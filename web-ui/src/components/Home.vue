        ...
        <el-container>
            <el-header class="navbar-wrapper">
                <el-menu :default-active="activeIndex" class="el-menu" mode="horizontal" :ellipsis="false" :router="true">
                    ...
                    <el-menu-item index="/recommend" class="min_hide">推荐食谱</el-menu-item>
                    <el-menu-item index="/foods" class="min_hide">找食谱</el-menu-item>
                    ...
                    <el-menu-item v-if="Islogin" class="min_hide"><el-dropdown>
                            ...
                            <template #dropdown>
                                <el-dropdown-menu>
                                    ...
                                    <el-dropdown-item @click="changeresume">喜好</el-dropdown-item>
            ...
            <div class="phone-tabbar">
                <el-menu :default-active="activeIndex" class="el-menu" mode="horizontal" :ellipsis="false" :router="true">
                    ...
                    <el-menu-item index="/foods"><div class="phone-tabbar-item"><el-icon><Suitcase /></el-icon><div>找食谱</div> </div></el-menu-item>
    ...
    watch: {
        ...
        userinfo:{
            ...
            handler(newValue, oldValue) {
                ...
                if (!newValue.init && this.view != 'resume'){
                    this.$router.push({path: '/resume'})
                    
                    this.$Message({ type: 'warning', message: '请您补充景点喜好消息' })
                }
