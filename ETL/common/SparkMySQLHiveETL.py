...
if __name__ == '__main__':
    TASK = [
        ...
        {"name": "旅游景点爬虫数据", "source_db": "spider", "source_tb": "travel", "db_num": 0, "t_num": 0,
         'sink_db': 'ods_travel', 'sink_tb': 'ods_travel_db_spider_t_travel', "update_column": "create_time",
         'partition_column': 'partition_date'},
        {"name": "用户简历信息", "source_db": "travel", "source_tb": "resume", "db_num": 0, "t_num": 0,
         'sink_db': 'ods_travel', 'sink_tb': 'ods_travel_db_travel_t_resume', "update_column": "last_update",
         'partition_column': 'partition_date'}
    ]
    MYSQL_CONNECT = {
        'host': '10.8.16.253',
