...
def dwd_run():
    TASK = [
        {"name": "爬虫数据ods->dwd", "source_db": "ods_foods", "source_tb": "ods_foods_db_spider_t_foods",
         'sink_db': 'dwd_foods', 'sink_tb': 'dwd_foods_db_spider_t_foods', "update_column": "cdc_sync_date",
         "SQL": '''select 
            ...
            from ods_foods.ods_foods_db_spider_t_foods''', 'partition_column': 'partition_date','is_del':True,
         },
        {
            "name": "用户喜好信息ods->dwd", "source_db": "ods_foods", "source_tb": "ods_foods_db_foods_t_resume",
            'sink_db': 'dwd_foods', 'sink_tb': 'dwd_foods_db_foods_t_resume', "update_column": "cdc_sync_date",
            'SQL': '''select 
            `id`,
            type1,
            type2,
            ...
            where t1.rank = 1''','partition_column':'partition_date','is_del':True
        },
    ...
    a = SparkMySQLHiveETL(DB_LOG_PARAMS=MYSQL_CONNECT, appName='ods_2_dwd', Task=TASK,
                          TYPE='update', outType=3,maxProcess=1)
